...
public class Demo31 {
	...
	public static void main(String[] args) {
		System.out.println(NumberOf1Between1AndN_Solution(130));
	}
	...
	public static int NumberOf1Between1AndN_Solution(int n) {
		...
		for (int i = 1; i <= n; i *= 10) {
			int a = n / i;
			int b = n % i;
			time += (a % 10 > 1) ? (a / 10 + 1) * i : (a / 10) * i + b + 1;
			time += (a % 10 == 0) ? -b - 1 : 0;
		}
		return time;
	}
	 ...
	 * //当i表示百位，且百位对应的数为1，如n=31156,i=
	 * 100，则a=311,b=56，此时百位对应的就是1，则共有a%10(最高两位0-30)
	 * 次是包含100个连续点，当最高两位为31（即a=311），本次只对应局部点00
	 * ~56，共b+1次，所有点加起来共有（a%10*100）+(b+1)，这些点百位对应为1    
